const BlogCard = () => {
  return (
    <div className="relative flex max-w-[30rem] max-h-[22rem] flex-col bg-white bg-clip-border text-gray-700 shadow-lg hover:shadow-2xl duration-300">
      <div className="relative m-0 overflow-hidden bg-transparent bg-clip-border text-gray-700">
